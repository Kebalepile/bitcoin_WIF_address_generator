...
(function () {
	...
	globalThis.__Crypto__.SHA256 = function (message, options) {
		var digestbytes = util.wordsToBytes(globalThis.__Crypto__.SHA256._sha256(message));
	...
	// The core
	globalThis.__Crypto__.SHA256._sha256 = function (message) {
	...
	globalThis.__Crypto__.SHA256._blocksize = 16;

	globalThis.__Crypto__.SHA256._digestsize = 32;
})();
